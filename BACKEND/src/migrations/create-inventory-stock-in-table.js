...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('inventory_stock_ins', {
      ...
      supplier: { type: Sequelize.STRING(100), allowNull: true },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('inventory_stock_ins')
  },
}
