...
const visibleMenuItems = computed(() => {
  ...
  // If user has SALES_FULL_ACCESS, show all menu items
  if (hasPermission(PERMISSION_IDS.SALES_FULL_ACCESS)) {
    return [
      {
        name: 'Dashboard',
  ...
  if (hasPermission(PERMISSION_IDS.SALES_VIEW_DASHBOARD)) {
    items.push({
      name: 'Dashboard',
      route: '/sales/dashboard',
      icon: LayoutDashboard,
