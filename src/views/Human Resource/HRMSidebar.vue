...
import { LayoutDashboard, Users, ClipboardCheck, FileSpreadsheet, UserCog } from 'lucide-vue-next'
...
<template>
  <BaseDepartmentSidebar departmentName="HR" :menuItems="menuItems" basePath="/hr" />
</template>
