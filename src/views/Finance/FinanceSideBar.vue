...
import { Landmark, LayoutDashboard, Wallet, FileSpreadsheet } from 'lucide-vue-next'
...
const menuItems = {
  Dashboard: {
    component: defineAsyncComponent({
      loader: () => import('./FinanceDashboard.vue'),
  ...
  Payroll: {
    component: defineAsyncComponent({
      loader: () => import('./FinancePayroll.vue'),
      loadingComponent: LoadingSpinner,
      delay: 1000,
    }),
    icon: Wallet,
    route: 'FinancePayroll',
  },
  'Finance Report': {
    component: defineAsyncComponent({
      loader: () => import('./FinanceReport.vue'),
      loadingComponent: LoadingSpinner,
      delay: 1000,
    }),
    ...
    <div class="w-80 min-h-screen p-4 bg-primaryColor">
      <div class="logo-section flex items-center mb-5 gap-4">
        ...
        <div class="text-log">
          ...
          <p class="text-[12px] text-gray-300">Financial Management</p>
        </div>
      </div>
